...
fixupDocumentReferences :: forall n. MonadLogger n => Regex -> GoNotebookTransformer -> Rope -> HoverContents -> n HoverContents
...
fixupDocumentReferences' :: forall n. MonadLogger n => Regex -> GoNotebookTransformer -> Text -> n Text
fixupDocumentReferences' docRegex transformer t =
  traverseOf ((regexing docRegex) . groups) (transformGroup transformer) t

  where
    transformGroup :: GoNotebookTransformer -> [Text] -> n [Text]
